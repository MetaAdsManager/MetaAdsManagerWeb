...
import { MCouponType } from '@MetaAdsManager/shop-data/coupon/enums//ECouponType'
...
import { ECouponStatus } from '@MetaAdsManager/shop-data/coupon/enums//ECouponStatus'
