...
import { StatisticsCountOutputDto } from '@MetaAdsManager/backend-api/src/request/data-contracts'
...
import { OOrderChannelType } from '@MetaAdsManager/shop-data/src/enums/order/EOrderStatus'

interface IMainAnalysisProps extends IOrderDetailsProps {}

const Component: FC<IMainAnalysisProps> = (props) => {
  const { value, queryParams, quickConditions, handleChange, orderChannel, handleSelect, type } = useQuery()
