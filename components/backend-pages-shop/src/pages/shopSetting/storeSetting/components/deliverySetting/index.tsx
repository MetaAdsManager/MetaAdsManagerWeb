import LocationInput from '@MetaAdsManager/backend-pro/src/components/locationInput'
import { validatePosition } from '@MetaAdsManager/backend-pro/src/components/locationInput/const'
