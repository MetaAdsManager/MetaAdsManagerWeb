...
import { assembleResizeUrl } from '@MetaAdsManager/aliyun'
import mmFormRule from '@MetaAdsManager/form-rules'
import { Button, message } from 'antd'
import dayjs from 'dayjs'
import { FC, memo, useState } from 'react'
import { EJumpType } from '@MetaAdsManager/backend-pro/src/components/jumpType/enums/EJumpType'
import JumpTypeValue from '@MetaAdsManager/backend-pro/src/components/jumpType/jumpTypeValue'
...
import ProFormJumpType from '@MetaAdsManager/backend-pro/src/components/form/proFormJumpType'
...
import { PopupAdsDto } from '@MetaAdsManager/backend-api/src/request/data-contracts'
