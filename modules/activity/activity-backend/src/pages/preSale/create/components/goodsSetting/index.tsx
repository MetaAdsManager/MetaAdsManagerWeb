...
import { api, GoodsSkuDTO, GoodsVO, MarketingActivityGoodsParam } from '@MetaAdsManager/backend-api'
import RequiredStar from '@MetaAdsManager/backend-pro/src/components/requiredStar'
