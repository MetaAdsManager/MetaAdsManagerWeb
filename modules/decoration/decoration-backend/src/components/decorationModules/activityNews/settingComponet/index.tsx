...
import NewsSelectModal from '../../../commModuleComponents/newsSelectModal';
            ...
            <TabContainer
                renderContent={
                    <SettingItem
                        ...
                        onShow={onShow}
                        columns={(j) => [
                            { title: '序号', align: 'center', valueType: 'index' },
                            { title: '资讯标题', dataIndex: 'title', align: 'center', width: 250 },
                            {
                                title: '操作',
                                align: 'center',
                                render: ($1, $2, i) => (
