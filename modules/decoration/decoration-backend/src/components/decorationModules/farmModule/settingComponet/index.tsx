...
import { BasicModuleImageDTO } from '@MetaAdsManager-modules/decoration-data'
import { EArrangeType, MArrangeType } from '@MetaAdsManager-modules/decoration-data/src/enums/EArrangeType'
    ...
    <Form {...formProps} className={styles.settingComponetStyle}>
      ...
      <Tabs defaultActiveKey="1">
        <TabPane tab="内容设置" key="1">
          <ImageFormList max={1} measure={measure} />
        </TabPane>

      </Tabs>
      {/* <TabContainer
        renderContent={<ImageFormList max={1} measure={measure} />
        }
        renderStyle={
          <>
            <ContentStyle />
