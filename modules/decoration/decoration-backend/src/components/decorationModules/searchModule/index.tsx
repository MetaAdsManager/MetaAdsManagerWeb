import { EModuleSearcType, getDefaultSearchModuleProps, IBasicModuleSearch, IModuleInfo, BasicModuleSignEnum } from '@MetaAdsManager-modules/decoration-data'
import * as styles from '@MetaAdsManager-modules/decoration-data/src/styles/search'
    ...
    <div style={{ ...styles.searchModuleStyle, ...style }}>
      <div style={styles.content}>
        ...
        <div style={styles.contentWrapper}>
          ...
          <input placeholder={renderSwiper ? undefined : placeholder} style={styles.input} readOnly disabled />
        </div>
      </div>
    </div>
  )
