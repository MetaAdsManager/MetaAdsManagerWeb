...
import IconFont from '@MetaAdsManager/backend-pro/src/components/iconFont'
import IconFontName from '@MetaAdsManager/backend-pro/src/components/iconFont/name'
import { FC, memo } from 'react'
import useComponentStyle from '../../../hooks/useComponentStyle'
import { IModuleInfo, BasicModuleSignEnum } from '@MetaAdsManager-modules/decoration-data'
