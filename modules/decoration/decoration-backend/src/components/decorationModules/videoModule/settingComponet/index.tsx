...
import { EVideoSource, MVideoSource } from '@MetaAdsManager-modules/decoration-data/src/enums/EVideoSource'
...
import MaterialModal from '@MetaAdsManager/backend-pages/src/components/material'
