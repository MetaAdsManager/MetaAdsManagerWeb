...
const ignoreModules: BasicModuleSignEnum[] = [BasicModuleSignEnum.DefaultTipBlock, BasicModuleSignEnum.Coupon, BasicModuleSignEnum.SliderWithImage, BasicModuleSignEnum.Video,
BasicModuleSignEnum.FreeShipping, BasicModuleSignEnum.MarketingActivity, BasicModuleSignEnum.PreSale]
