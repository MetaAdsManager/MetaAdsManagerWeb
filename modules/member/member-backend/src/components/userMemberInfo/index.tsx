import { EMemberCardType, MMemberCardType } from '@MetaAdsManager-modules/member-data/src/enums/EMemberCardType'
import { MMemberLevelType } from '@MetaAdsManager-modules/member-data/src/enums/EMemberLevelType'
import { EMemberRangeType } from '@MetaAdsManager-modules/member-data/src/enums/EMemberRangeType'
import { MMemberRightsType } from '@MetaAdsManager-modules/member-data/src/enums/EMemberRightsType'
import { api, MemCardDto, MemCardLevelDto } from '@MetaAdsManager/backend-api'
import { mmTimes } from '@MetaAdsManager/utils/src/mmCurrency'
