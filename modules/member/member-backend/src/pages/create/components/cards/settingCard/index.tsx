...
import { EMemberCardGetMethod, OMemberCardGetMethod } from '@MetaAdsManager-modules/member-data/src/enums/EMemberCardGetMethod'
import { EMemberCardType, OMemberCardType } from '@MetaAdsManager-modules/member-data/src/enums/EMemberCardType'
