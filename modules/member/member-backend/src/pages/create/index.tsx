...
import { EMemberRightsType } from '@MetaAdsManager-modules/member-data/src/enums/EMemberRightsType'
import { api, MemCardDto, MemCardRightsDto, MemCardSaveDto } from '@MetaAdsManager/backend-api'
...
import { mmDivide, mmTimes } from '@MetaAdsManager/utils/src/mmCurrency'
    ...
    <PageContainer loading={service.loading} className={styles.createStyle}>
      <TaskContext.Provider value={contextValue}>
        ...
        {service.activeKey === 'muti' ? (
          service.isEdit ? (
            <MutiLevelCardForm form={form} />
          ) : (
            <MutiLevelDetail data={service.card} />
          )
        ) : service.isEdit ? (
          <SingleLevelCardForm form={form} />
        ) : (
