import { getPayTypeName, MPayType } from '@MetaAdsManager/shop-data/src/enums/order/EPayType'
  ...
  return (
    <Card title="订单信息">
      <Descriptions {...descriptionsProps}>
        ...
        <Descriptions.Item label="支付方式">{data.payType !== undefined ? getPayTypeName(data.payType, data.balanceFlag) : '/'}</Descriptions.Item>
