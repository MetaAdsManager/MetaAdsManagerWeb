...
import { ShipInfoParam } from '@MetaAdsManager/backend-api/src/request/data-contracts'
import { EOrderShipMethod } from '@MetaAdsManager-modules/order-data/enums/EOrderShipMethod'
