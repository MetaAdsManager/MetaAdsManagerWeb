...
import { ECouponExpireType } from '@MetaAdsManager/shop-data/coupon/enums/ECouponExpireType'
import { ECouponStatus, MCouponStatus } from '@MetaAdsManager/shop-data/coupon/enums/ECouponStatus'
import { ECouponType } from '@MetaAdsManager/shop-data/coupon/enums/ECouponType'
import { CouponTemplateVo } from '@MetaAdsManager/backend-api'
